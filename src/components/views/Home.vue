<template>
  <div id="container" ref="home">

  </div>
</template>

<script>
  import { Polyline, Renderer, Transform, Geometry, Program, Mesh, Vec3, Vec2, Color } from 'ogl';
    ...
    mounted(){
      const vertex = `
...

        {
          ...
          this.$refs.home.appendChild(gl.canvas)
